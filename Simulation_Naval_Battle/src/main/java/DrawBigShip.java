...
public class DrawBigShip {

    private BufferedImage _image;
    private BufferedImage [][] _t;
    private File _file;
    public void draw(Graphics g, Radar radar) throws IOException {

        for (int n = 0; n < radar.Fleet1.countShips(); n++)
            if(radar.Fleet1.shipType(n) == "BigShip") {
                ...
                //wstawienie grafiki
                _file = new File("./src/main/resources/ships/Spain_BigShip.png");
                ...
                if(direction==0){
                    ...
                    g.fillOval(position_X * Board.Size_x , position_Y * Board.Size_y , 10, 10);
                    g.fillOval(position_X * Board.Size_x + 30, position_Y * Board.Size_y , 10, 10);
                    g.fillOval(position_X * Board.Size_x + 59, position_Y * Board.Size_y , 10, 10);
                    if(life==3){
                ...
                if(direction==1){
                    ...
                    g.fillOval(position_X * Board.Size_x +59, position_Y * Board.Size_y +49, 10, 10);
                    if(life==3){
                        g.setColor(new Color(0x4DC539));
                ...
                if(direction==2){
                    g.setColor(new Color(0x5E1D98));
                    g.fillOval(position_X * Board.Size_x , position_Y * Board.Size_y +50, 10, 10);
                    g.fillOval(position_X * Board.Size_x +28, position_Y * Board.Size_y+50, 10, 10);
                    g.fillOval(position_X * Board.Size_x + 55, position_Y * Board.Size_y+50 , 10, 10);
                    if(life==3){
                        g.setColor(new Color(0x4DC539));
                        g.fillRect(position_X * Board.Size_x , position_Y * Board.Size_y , 10, 10);
                ...
                if(direction==3){
                    g.setColor(new Color(0x5E1D98));
                    g.fillOval(position_X * Board.Size_x +1, position_Y * Board.Size_y +1, 10, 10);
                    g.fillOval(position_X * Board.Size_x +1, position_Y * Board.Size_y+25, 10, 10);
                    g.fillOval(position_X * Board.Size_x +1, position_Y * Board.Size_y+49 , 10, 10);
                    if(life==3){
                        g.setColor(new Color(0x4DC539));
                        g.fillRect(position_X * Board.Size_x +60 , position_Y * Board.Size_y , 10, 10);
        ...
        for (int n = 0; n < radar.Fleet2.countShips(); n++)
            if(radar.Fleet2.shipType(n) == "BigShip") {
                ...
                //wstawienie grafiki
                _file = new File("./src/main/resources/ships/Pirate_BigShip.png");
                _image = ImageIO.read(_file);
                _t = new BufferedImage[10][10];
                for(int y=0;y<10;y++){
                    for(int x=0;x<10;x++){
                ...
                if(direction==0){
                    ...
                    if(life==2){
                        g.setColor(new Color(0xE8F105));
                        g.fillRect(position_X * Board.Size_x +25 , position_Y * Board.Size_y +45, 10, 10);
                        g.fillRect(position_X * Board.Size_x + 35, position_Y * Board.Size_y +45, 10, 10);
                        g.fillRect(position_X * Board.Size_x + 45, position_Y * Board.Size_y +45, 10, 10);
                        g.fillRect(position_X * Board.Size_x + 55, position_Y * Board.Size_y +45, 10, 10);
                    }
                    if(life==1) {
                        g.setColor(new Color(0xF800E3));
                        g.fillRect(position_X * Board.Size_x + 55, position_Y * Board.Size_y+45, 10, 10);
