...
public class DrawMediumShip {
    ...
    public void draw(Graphics g, Radar radar){
        ...
        for (int n = 0; n < radar.Fleet1.countShips(); n++)
            if(radar.Fleet1.shipType(n) == "MediumShip") {
                ...
                //wstawienie grafiki
                _file = new File("./src/main/resources/ships/Spain_MediumShip.png");
                try {
                ...
                if(direction==2){
                    ...
                    g.fillOval(position_X * Board.Size_x + 60, position_Y * Board.Size_y+50 , 10, 10);
                    if(life==2){
                        g.setColor(new Color(0x4DC539));
                        g.fillRect(position_X * Board.Size_x , position_Y * Board.Size_y , 10, 10);
        ...
        for (int n = 0; n < radar.Fleet2.countShips(); n++)
            if(radar.Fleet2.shipType(n) == "MediumShip") {
                ...
                //wstawienie grafiki
                _file = new File("./src/main/resources/ships/Pirate_MediumShip.png");
                try {
                    _image = ImageIO.read(_file);
                } catch (IOException e) {
                    e.printStackTrace();
